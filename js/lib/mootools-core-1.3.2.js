...
XXX:
Modified by Sean M 13/12/11
    Added the .nowrap() method to Class, for performance.
...
(function () {
    ...
    var implement = function (key, value, retain) {
        ...
        if (typeOf(value) == 'function') {
            ...
            // SeanM: Added $nowrap here for perf
            this.prototype[key] = (retain || value.$nowrap) ? value : wrap(this, key, value);
        } else {
